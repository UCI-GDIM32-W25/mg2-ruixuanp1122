...
Overall, the final game closely follows my original plan, with a few adjustments made during coding to improve clarity and gameplay flow. Separating each system into its own script made the project easier to build and debug.
## Open-Source Assets
